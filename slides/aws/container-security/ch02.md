...
```shell
$ (~/environment/container-security/ch02/network-policy)
$ kubens kube-system
...
```shell
$ (~/environment/container-security/ch02/rbac)
$ kubens kube-system
$ kubectl get role
...
```yaml
$ (~/environment/container-security/ch02/rbac/manifests/rbac-admin.yaml)
…
rules:
 - apiGroups: ["*"]
   resources: ["pods"]
...
```yaml
$ (~/environment/container-security/ch02/rbac/manifests/rbac-dev.yaml)
…
rules:
 - apiGroups: ["*"]
   resources: ["pods"]
