...
---
name: Visit https://travis-ci.org/

# Visit https://travis-ci.org/

.center[![:scale 85%](images/ch01/visit-travisci.png)]
...
---
name: Add Repository into Travis CI
...
```dockerfile
(~/environment/container-security/ch01/Dockerfile)
FROM composer:1.7.2
...
```shell
$ (~/environment/container-security/ch01)
$ git add .
...
```shell
(~/environment/container-security/.travis.yml)
